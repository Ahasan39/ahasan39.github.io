...
import ecomHero from '@/assets/screenshots/khadyobitan-hero.png';
...
export const projects: Project[] = [
  {
    ...
    image: ecomHero,
    screenshots: [
      { title: 'Public Homepage', description: 'Live React-based landing page with bilingual support', image: ecomHero },
